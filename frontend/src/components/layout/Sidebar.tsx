...
const NavIcon = ({ name }: { name: string }) => {
  const icons: Record<string, string> = {
    ...
    handshake: "M7 11V7a5 5 0 0110 0v4m-9 8v2a2 2 0 01-2 2H4a2 2 0 01-2-2v-2m18 0v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2m-2-4h4a2 2 0 012 2v2a2 2 0 01-2 2h-4a2 2 0 01-2-2v-2a2 2 0 012-2zM8 11h8a2 2 0 012 2v2a2 2 0 01-2 2H8a2 2 0 01-2-2v-2a2 2 0 012-2z",
